...
quad_params = {
    ...
    'c_Dx': 9.1785e-3,  # parasitic drag in body x axis, N/(m/s)**2 (from URDF file)
    'c_Dy': 9.1785e-3,  # parasitic drag in body y axis, N/(m/s)**2 (from URDF file)
    'c_Dz': 10.311e-3,  # parasitic drag in body z axis, N/(m/s)**2 (from URDF file)

    # Rotor properties
    # See "System Identification of the Crazyflie 2.0 Nano Quadrocopter", Forster 2015.
    'k_eta': 1.28e-9,           # thrust coefficient N/(rad/s)**2
    'k_m':   7.94e-12,           # yaw moment coefficient Nm/(rad/s)**2
